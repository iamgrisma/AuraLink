-- ============================================================
-- AuraLink — Full Database Schema (Cloudflare D1 / SQLite)
-- ============================================================
-- Run this entire file in the D1 Console for a fresh setup.
-- All statements use IF NOT EXISTS / OR IGNORE — safe to re-run.
-- No FOREIGN KEY constraints (prevents D1 dashboard crash).
